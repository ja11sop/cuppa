...
from cppscons.cpp.create_version_file_cpp import CreateVersionHeaderCpp, CreateVersionFileCpp
from cppscons.cpp.run_boost_test import RunBoostTestEmitter, RunBoostTest
from cppscons.cpp.run_process_test import RunProcessTestEmitter, RunProcessTest
from cppscons.cpp.run_gcov_coverage import RunGcovCoverageEmitter, RunGcovCoverage
from cppscons.output_processor import command_available
...
class Clang(object):
    ...
    def __init__( self, version ):
        ...
        if cppscons.build_platform.name() == "Linux":
