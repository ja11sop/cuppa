...
import cppscons.timer
import cppscons.sconscript_progress
from cppscons.output_processor import IncrementalSubProcess
...
class TestSuite:
    ...
    def __init__( self, name, scons_env ):
        ...
        cppscons.sconscript_progress.SconscriptProgress.register_callback( scons_env, self.on_progress )
        ...
        self._suite['total_cpu_times']   = cppscons.timer.CpuTimes( 0, 0, 0, 0 )
    ...
    def enter_test( self, test, expected='success' ) :
        ...
        test_case['timer']    = cppscons.timer.Timer()
