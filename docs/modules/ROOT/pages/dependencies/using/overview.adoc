...
* Use xref:dependencies/using/location.adoc[Location dependencies] for source trees, repositories, archives, and
  header-only libraries.
* Use xref:dependencies/using/packages.adoc[Package dependencies] for prebuilt registry archives.
* Use xref:dependencies/using/conan.adoc[Conan packages] when Conan 2 owns dependency resolution.
* Use xref:dependencies/using/builtins.adoc[Built-in dependencies] for integrations registered with Cuppa.
