...
xref:dependencies/using/builtins/boost.adoc[Boost] and xref:dependencies.adoc[Dependencies].
...
Built-ins such as xref:dependencies/using/builtins/quince.adoc[Quince] only ask for `boost` and call
...
* xref:dependencies.adoc[Dependencies] · xref:dependencies/publishing/packages.adoc[Publishing packages]
* xref:methods/flags-and-toolchain.adoc[Flags and toolchain]
