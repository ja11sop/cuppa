...
| Remove a whole build tree, a dependency, or a stale download | Builds: `--remove-builds` / `--remove-all-builds` ([#134](https://github.com/ja11sop/cuppa/issues/134) / #140); dependencies: `--remove-dependencies` / `--remove-all-dependencies` ([#134](https://github.com/ja11sop/cuppa/issues/134) / #142); downloads still manual |
