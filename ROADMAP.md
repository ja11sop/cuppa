...
| `package-build-publish-deps` | Opt-in cascade: from a tip publisher **or consume-only tip**, topo-build and `--publish-package` each GitLab package dep then tip publish **or tip build only** (`--publish-cascade-dependencies`) | Medium | Phase 1–4 **done on master** ([#302](https://github.com/ja11sop/cuppa/pull/302)–[#330](https://github.com/ja11sop/cuppa/pull/330)): enable+companion actions, plan/collect/clone/update, skip-if-current, single `cuppa-publish.json`, consume-site `package_source`, pure-consume tips. Q11 tip payload overlay on [#333](https://github.com/ja11sop/cuppa/pull/333). Open: Q7 collect reused/cloned; Q1/Q4 publishers `--list-*` / keying. Design: [`package-build-publish-deps.md`](design/plans/package-build-publish-deps.md). [#297](https://github.com/ja11sop/cuppa/issues/297). |
