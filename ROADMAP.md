...
| `profiles-violation-report` | `prof-report-error-limit` — inventory implies unlimited per-TU diagnostic cap | High | Issue draft [`issues/profiles-report-implied-error-limit.md`](design/issues/profiles-report-implied-error-limit.md); [`cxx-profiles-report.md`](design/plans/cxx-profiles-report.md) §Implied diagnostic error limit; **1.9.0** |
