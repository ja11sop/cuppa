...
| `static-glob` | RecursiveGlob (disk + `Dir.entries` + full Repository); GlobFiles; Filter path parity | Medium | **Landing** — [#231](https://github.com/ja11sop/cuppa/pull/231), [`static-glob-rename.md`](design/plans/static-glob-rename.md) |
