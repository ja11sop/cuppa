...
| `static-glob` | RecursiveGlob as recursive snapshot; shared path vocabulary; honest SCons Glob docs; Filter path parity | Medium | **Landing** — [`static-glob-rename.md`](design/plans/static-glob-rename.md) |
