...
| Colourised Antora report samples | In progress — [#252](https://github.com/ja11sop/cuppa/issues/252); [`colourised-doc-samples.md`](design/plans/colourised-doc-samples.md) |
...
| `doc-output-samples` | Capture report output as semantic HTML for Antora and local preview | Low | **In progress** [#252](https://github.com/ja11sop/cuppa/issues/252); [`colourised-doc-samples.md`](design/plans/colourised-doc-samples.md); not Shiki `ansi` |
