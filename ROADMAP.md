...
| ID | Work | Priority | Notes |
|----|------|----------|-------|
| `storage-listing-removal` | `--list-*`, `--remove-*`, `--purge-*`, `--wipe-*` for builds, dependencies, and downloads | Medium | Umbrella [#134](https://github.com/ja11sop/cuppa/issues/134) closed by [#144](https://github.com/ja11sop/cuppa/pull/144). Builds #140; list-deps #141; remove #142; archive clean #143; Phase 4 list-downloads + purge #144. Phase 3 polish [#145](https://github.com/ja11sop/cuppa/issues/145). Wipe [#146](https://github.com/ja11sop/cuppa/issues/146) closed by [#150](https://github.com/ja11sop/cuppa/pull/150). Remaining: [#138](https://github.com/ja11sop/cuppa/issues/138) / [#135](https://github.com/ja11sop/cuppa/issues/135). |
| `develop-clone` | `--clone-develop` for a develop working copy that is configured but not yet on disk | Medium | Design settled (§3.7): refuse pins; recurse submodules; dedicated `Git.clone` on unexpanded URL. GitHub [#138](https://github.com/ja11sop/cuppa/issues/138) |
| `develop-branch-align` | `--checkout-develop-branch` / `--reset-develop-branch[=…]` to align local develop copies onto a feature branch and back to the develop base (`--location-base-branch`) | Medium | §3.8; [#153](https://github.com/ja11sop/cuppa/issues/153). Act where safe; `--list-develop` reports what needs a person |
