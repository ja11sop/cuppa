...
| `--clone-develop` / `--checkout-develop-branch` / `--reset-develop-branch` / `--location-base-branch` | Landing in [#154](https://github.com/ja11sop/cuppa/pull/154) (closes [#138](https://github.com/ja11sop/cuppa/issues/138) / [#153](https://github.com/ja11sop/cuppa/issues/153)) |
...
| `develop-clone` | `--clone-develop` for a develop working copy that is configured but not yet on disk | Medium | Landing in [#154](https://github.com/ja11sop/cuppa/pull/154); closes [#138](https://github.com/ja11sop/cuppa/issues/138) |
| `develop-branch-align` | `--checkout-develop-branch` / `--reset-develop-branch[=…]` / `--location-base-branch` | Medium | Landing in [#154](https://github.com/ja11sop/cuppa/pull/154); closes [#153](https://github.com/ja11sop/cuppa/issues/153) |
