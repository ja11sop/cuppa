...
| `develop-branch-align` | `--checkout-develop-branch` / `--reset-develop-branch` to align local develop copies onto a feature branch and back to the default | Medium | §3.8; [#153](https://github.com/ja11sop/cuppa/issues/153). Act where safe; `--list-develop` reports what needs a person |
