...
| `tc-dep-profiles` | [#127](https://github.com/ja11sop/cuppa/issues/127) `--cxx-profiles*` / `-fprofiles` (MVP `--profiles*` shipped [#177](https://github.com/ja11sop/cuppa/pull/177)) | Medium | Design [`cxx-profiles.md`](design/plans/cxx-profiles.md); follow-ons: cxx CLI rename + `--cxx-disable-error-limit` + enforce composition; supply [#160](https://github.com/ja11sop/cuppa/issues/160) done |
