...
- Conan integration tests (`test_conan`): generators_folder reuse, full install + build, shared-library `--test` runtime paths, pip plugin discovery, and offline cache-miss failure (skipped when Conan 2 is unavailable).
