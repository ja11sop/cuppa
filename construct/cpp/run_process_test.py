...
import construct.timer
import construct.sconscript_progress
from construct.output_processor import IncrementalSubProcess
...
class TestSuite:
    ...
    def __init__( self, name, scons_env ):
        ...
        construct.sconscript_progress.SconscriptProgress.register_callback( scons_env, self.on_progress )
        ...
        self._suite['total_cpu_times']   = construct.timer.CpuTimes( 0, 0, 0, 0 )
    ...
    def enter_test( self, test, expected='success' ) :
        ...
        test_case['timer']    = construct.timer.Timer()
