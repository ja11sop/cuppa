...
from construct.cpp.create_version_file_cpp import CreateVersionHeaderCpp, CreateVersionFileCpp
from construct.cpp.run_boost_test import RunBoostTestEmitter, RunBoostTest
from construct.cpp.run_process_test import RunProcessTestEmitter, RunProcessTest
from construct.cpp.run_gcov_coverage import RunGcovCoverageEmitter, RunGcovCoverage
from construct.output_processor import command_available
...
class Clang(object):
    ...
    def __init__( self, version ):
        ...
        if construct.build_platform.name() == "Linux":
