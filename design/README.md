...
| [`plans/package-runtime-paths.md`](plans/package-runtime-paths.md) | in progress | GitLab `BuildWith` runtime ENV (shipped); `cmake_install_rpath_defines` / `cmake_prefix_path` (shipped); private publisher `LD_LIBRARY_PATH` cleanup remaining |
