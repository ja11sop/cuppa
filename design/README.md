...
| [`plans/package-build-publish-deps.md`](plans/package-build-publish-deps.md) | in progress | Cascade Phase 1–4 + Q11 + Q7 on master ([#302](https://github.com/ja11sop/cuppa/pull/302)–[#334](https://github.com/ja11sop/cuppa/pull/334)); Q1 list/remove publishers on this branch; open Q4 stem keying — ROADMAP `package-build-publish-deps`; [#297](https://github.com/ja11sop/cuppa/issues/297) || [`plans/package-use-libs-defaults.md`](plans/package-use-libs-defaults.md) | in progress | Shared-aware `use_libs` + package `default_use_libs` so auto-enable links small packages without `AppendUnique` — ROADMAP `package-use-libs-defaults` |
