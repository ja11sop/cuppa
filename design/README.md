...
| [`plans/list-deps-requires-closure.md`](plans/list-deps-requires-closure.md) | done | `--list-dependencies`: nest traveling-manifest closure under tip `requires` as sized trees; pass A complete (Pass B split/compact deferred) |
...
| [`plans/console-mode-banners.md`](plans/console-mode-banners.md) | proposal | Mode banners (OFFLINE, CASCADE PLAN, …) as report surface so `-Q` does not hide them; coordinates with quiet-tty-heartbeat |
...
| [`plans/local-gate.md`](plans/local-gate.md) | proposal | `python -m scripts.local_gate` preflight + lint/unit/integration orchestrator for agents/humans — ROADMAP `local-gate` |
...
| [`plans/package-build-publish-deps.md`](plans/package-build-publish-deps.md) | in progress | Cascade Phase 1–4 + Q11 + Q7 on master ([#302](https://github.com/ja11sop/cuppa/pull/302)–[#334](https://github.com/ja11sop/cuppa/pull/334)); Q1a list/remove publishers + develop chrome on [#335](https://github.com/ja11sop/cuppa/pull/335); open Q1b deps-list publishers section + Q4 stem keying — ROADMAP `package-build-publish-deps`; [#297](https://github.com/ja11sop/cuppa/issues/297) |
...
| [`plans/package-metadata-amend.md`](plans/package-metadata-amend.md) | done | Metadata-only amend/republish (`--amend-package-manifest`); traveling file is `cuppa-publish.json` (Phase 2d) — ROADMAP `package-metadata-amend`; [#299](https://github.com/ja11sop/cuppa/issues/299) / [#300](https://github.com/ja11sop/cuppa/pull/300) |
