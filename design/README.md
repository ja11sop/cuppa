...
| [`plans/removal-options.md`](plans/removal-options.md) | in progress | Phases 1–5 + Phase 3 polish done; wipe [#146](https://github.com/ja11sop/cuppa/issues/146) / [#150](https://github.com/ja11sop/cuppa/pull/150) — §4.15 on branch (selectors, repository rename, shared report); Phases 6 / §3.7 open — [#135](https://github.com/ja11sop/cuppa/issues/135) / [#138](https://github.com/ja11sop/cuppa/issues/138) |
