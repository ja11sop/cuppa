...
| [`plans/stage-develop-locations.md`](plans/stage-develop-locations.md) | in progress | Location `--stage-develop` nest build/clean shipped ([#313](https://github.com/ja11sop/cuppa/pull/313)); L4 plan + ordered stages next — ROADMAP `stage-develop-locations` |
