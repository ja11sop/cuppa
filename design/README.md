...
| [`plans/cxx-profiles.md`](plans/cxx-profiles.md) | in progress | C++ Profiles MVP ([#177](https://github.com/ja11sop/cuppa/pull/177)); `--cxx-profiles*`, `--cxx-disable-error-limit`, modules vocabulary; enforce composition — [#127](https://github.com/ja11sop/cuppa/issues/127) |
