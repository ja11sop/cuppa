...
| [`plans/cxx-profiles.md`](plans/cxx-profiles.md) | proposal | Opt-in C++ Profiles (`--profiles` / `--profiles-enforce=`); BuildProfile naming kept; [#127](https://github.com/ja11sop/cuppa/issues/127) / [#176](https://github.com/ja11sop/cuppa/pull/176) |
