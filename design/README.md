...
| [`plans/removal-options.md`](plans/removal-options.md) | in progress | Phases 1, 2, 4, 5 + Phase 3 listing/removal/archive-clean done (#140–#144); #144 closes [#134](https://github.com/ja11sop/cuppa/issues/134); deferred Phase 3 polish: `used_by`, Conan meta, default-branch quirk, docs split; then `--wipe-dependencies` (clear-down only); native `du` parked; Phases 6 / §3.7 still open — [#135](https://github.com/ja11sop/cuppa/issues/135) / [#138](https://github.com/ja11sop/cuppa/issues/138) |
