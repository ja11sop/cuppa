...
| [`plans/colourised-doc-samples.md`](plans/colourised-doc-samples.md) | in progress | Semantic HTML report samples + local preview — [#252](https://github.com/ja11sop/cuppa/issues/252) |
