...
| [`plans/package-develop-local.md`](plans/package-develop-local.md) | in progress | Package `--develop` source-tree consume (A–D shipped); Slice F first-publish defer-404 under cascade — [#297](https://github.com/ja11sop/cuppa/issues/297) |
| [`plans/cascade-defer-404.md`](plans/cascade-defer-404.md) | in progress | Slice F: tip registry 404 defer under cascade; project D full publish soak done — [#316](https://github.com/ja11sop/cuppa/pull/316) / [#297](https://github.com/ja11sop/cuppa/issues/297) |
| [`plans/publish-package-parallel-side-effect.md`](plans/publish-package-parallel-side-effect.md) | in progress | `PublishPackage` archive SideEffect + CMake `--parallel N`; live soak done — [#319](https://github.com/ja11sop/cuppa/pull/319) / [#317](https://github.com/ja11sop/cuppa/issues/317) / [#318](https://github.com/ja11sop/cuppa/issues/318) |
| [`plans/stage-develop-locations.md`](plans/stage-develop-locations.md) | in progress | Location `--stage-develop` (L1/L2) + plan (L4) + L3 tip stage consume — on [#315](https://github.com/ja11sop/cuppa/pull/315); ROADMAP `stage-develop-locations` || [`issues/package-build-provenance.md`](issues/package-build-provenance.md) | issue draft | A published package records the source revisions it was built from (`built_from` in `cuppa-publish.json`); the packaging recipe's own revision is deliberately not identity — [#297](https://github.com/ja11sop/cuppa/issues/297) |
...
| [`plans/integration-parallel-local.md`](plans/integration-parallel-local.md) | proposal | Modest pytest-xdist for local integration gate (~2–3 min); HOME isolation first — ROADMAP `integration-parallel-local` |
| [`plans/package-download-refresh.md`](plans/package-download-refresh.md) | proposal | Opt-in re-fetch of GitLab package archives after same-version republish (`--refresh-downloads` provisional) — ROADMAP `package-download-refresh` |
| [`plans/package-build-publish-deps.md`](plans/package-build-publish-deps.md) | in progress | Cascade `--build-and-publish-dependencies`; traveling `cuppa-publish.json` + `package_source`; Phase 1 shipped, Phase 2a `--cascade-plan` in progress — ROADMAP `package-build-publish-deps`; [#297](https://github.com/ja11sop/cuppa/issues/297) |
| [`plans/package-use-libs-defaults.md`](plans/package-use-libs-defaults.md) | in progress | Shared-aware `use_libs` + package `default_use_libs` so auto-enable links small packages without `AppendUnique` — ROADMAP `package-use-libs-defaults` |
| [`plans/package-metadata-amend.md`](plans/package-metadata-amend.md) | in progress | Metadata-only amend/republish of `cuppa-dependency.json` without a full package rebuild — ROADMAP `package-metadata-amend`; [#299](https://github.com/ja11sop/cuppa/issues/299) |
