...
| [`plans/stage-develop-locations.md`](plans/stage-develop-locations.md) | in progress | Location `--stage-develop` shipped ([#313](https://github.com/ja11sop/cuppa/pull/313)); L4 `--stage-develop-plan` + leaf-first order on branch — ROADMAP `stage-develop-locations` |
