...
| [`plans/package-build-publish-deps.md`](plans/package-build-publish-deps.md) | proposal | Cascade `--build-and-publish-dependencies`; traveling `cuppa-publish.json` + `package_source` (after #294) — ROADMAP `package-build-publish-deps` |
...
| [`plans/package-metadata-amend.md`](plans/package-metadata-amend.md) | proposal | Metadata-only amend/republish of `cuppa-dependency.json` without a full package rebuild — ROADMAP `package-metadata-amend` |
