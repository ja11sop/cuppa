...
| [`plans/package-build-publish-deps.md`](plans/package-build-publish-deps.md) | in progress | Cascade `--build-and-publish-dependencies`; traveling `cuppa-publish.json` + `package_source` — ROADMAP `package-build-publish-deps`; [#297](https://github.com/ja11sop/cuppa/issues/297) |
