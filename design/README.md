...
| [`plans/doc-folder-layout.md`](plans/doc-folder-layout.md) | proposal | Antora child pages under `dependencies/`, `cxx-profiles/`, `toolchains/` — ROADMAP `doc-folder-layout` |
