...
| [`plans/package-runtime-paths.md`](plans/package-runtime-paths.md) | shipped | GitLab `BuildWith` runtime ENV; `cmake_install_rpath_defines` / `cmake_prefix_path`; private publisher cleanup done |
