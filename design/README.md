...
| [`plans/selection-filter-examples-docs.md`](plans/selection-filter-examples-docs.md) | done | Remove/wipe selection docs: types table, inventory, glance Matches, worked why, CLI copy |
