...
| [`plans/static-glob-rename.md`](plans/static-glob-rename.md) | in progress | RecursiveGlob (disk + `Dir.entries` + full Repository trees) vs SCons Glob; GlobFiles; Filter — ROADMAP `static-glob` |
