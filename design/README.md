...
| [`plans/dependencies-docs-four-hubs.md`](plans/dependencies-docs-four-hubs.md) | in progress | Dependencies Antora: Using / Managing / Publishing / Authoring hubs; Using-first usability story; align list-deps Option A |
