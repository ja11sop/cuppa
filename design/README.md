...
| [`plans/cxx-profiles-report.md`](plans/cxx-profiles-report.md) | in progress | `--cxx-profiles-report`: classify/dedupe Profiles diagnostics — ROADMAP `profiles-violation-report` / **1.8.0** — slice G on [#197](https://github.com/ja11sop/cuppa/pull/197) |
