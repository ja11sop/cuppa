...
| [`plans/cmake-drive-and-package-staging.md`](plans/cmake-drive-and-package-staging.md) | in progress | Drive CMake from publisher sconscripts (Cuppa→CMAKE_* mapping); #209 staging; Toolchain()/Variant()/Has* accessors — ROADMAP / [#209](https://github.com/ja11sop/cuppa/issues/209) |
