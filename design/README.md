...
| [`plans/static-glob-rename.md`](plans/static-glob-rename.md) | in progress | `StaticGlob` + shared path vocabulary; deprecate `RecursiveGlob` / `GlobFiles` — ROADMAP `static-glob` |
