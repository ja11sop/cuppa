...
| [`plans/publish-package-parallel-side-effect.md`](plans/publish-package-parallel-side-effect.md) | proposal | `PublishPackage` archive as SCons `SideEffect` so `--parallel` cannot race `.published` — [#317](https://github.com/ja11sop/cuppa/issues/317) |
