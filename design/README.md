...
| [`plans/cmake-package-prefix.md`](plans/cmake-package-prefix.md) | in progress | `package_paths` + `cmake_prefix_path_for`; publisher dep `version` fill from BuildWith — ROADMAP 1.11.0 |
