...
| [`plans/removal-options.md`](plans/removal-options.md) | in progress | Phases 1, 2, 5 done; Phase 3 **listing** done on branch (tree / verbose / `[D]`); removal, Conan meta, default-branch quirk, docs split (§7.1), Phases 4 / 6 / §3.7 still open — see plan progress snapshot; [#134](https://github.com/ja11sop/cuppa/issues/134) / [#135](https://github.com/ja11sop/cuppa/issues/135) |
