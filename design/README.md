...
| [`plans/static-glob-rename.md`](plans/static-glob-rename.md) | in progress | RecursiveGlob as recursive snapshot vs SCons directory Glob; Filter path parity — ROADMAP `static-glob` |
