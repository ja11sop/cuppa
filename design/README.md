...
| [`plans/package-build-publish-deps.md`](plans/package-build-publish-deps.md) | in progress | Cascade `--build-and-publish-dependencies`; Phase 2c done [#323](https://github.com/ja11sop/cuppa/pull/323); Phase **2d** single `cuppa-publish.json` — ROADMAP `package-build-publish-deps`; [#297](https://github.com/ja11sop/cuppa/issues/297) |
