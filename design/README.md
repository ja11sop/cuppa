...
| [`plans/cxx-profiles.md`](plans/cxx-profiles.md) | in progress | C++ Profiles 1.7.0 ([#177](https://github.com/ja11sop/cuppa/pull/177), PR branch F–H); `--cxx-profiles*`, composition, `--cxx-disable-error-limit`, modules vocabulary — [#127](https://github.com/ja11sop/cuppa/issues/127) |
