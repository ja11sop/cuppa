...
| [`plans/download-progress.md`](plans/download-progress.md) | in progress | Shared transfer progress (bar / bytes / % / rate / ETA); phase 1 + tar extract (#165); next GitLab → zip → Conan → git |
