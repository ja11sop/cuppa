...
| [`plans/cxx-profiles-report.md`](plans/cxx-profiles-report.md) | in progress | `--cxx-profiles-report`: classify/dedupe Profiles diagnostics — ROADMAP `profiles-violation-report` / **1.8.0** — **E** + **F-min** merged [#198](https://github.com/ja11sop/cuppa/pull/198); **`prof-report-method-semantics`** plan settled ([#199](https://github.com/ja11sop/cuppa/issues/199)) — implementation next |
