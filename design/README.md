...
| [`plans/removal-options.md`](plans/removal-options.md) | in progress | Phases 1, 2, 5 + Phase 3 listing (#141) + Slice D removal (#142 / §4.13) done on master; archive clean (§4.14.3) done on `134_archive_clean`; deferred Phase 3 polish: `used_by`, Conan meta, default-branch quirk, docs split; native `du` exact bytes (§4.5.1) parked future-only; Phases 4 / 6 / §3.7 still open — see plan progress snapshot; [#134](https://github.com/ja11sop/cuppa/issues/134) / [#135](https://github.com/ja11sop/cuppa/issues/135) |
