...
| [`plans/download-progress.md`](plans/download-progress.md) | in progress | Shared transfer progress (bar / bytes / % / rate / ETA); phase 1 location+toolchain (#165); next extract → GitLab → zip → Conan → git |
