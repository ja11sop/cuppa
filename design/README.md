...
| [`plans/removal-options.md`](plans/removal-options.md) | in progress | Phases 1, 2, 5 + Phase 3 listing done on master (#141); Slice D removal done on `134_remove_dependencies` (§4.13 / name gate); archive clean (§4.14.3), Conan meta, default-branch quirk, docs split, Phases 4 / 6 / §3.7 still open — see plan progress snapshot; [#134](https://github.com/ja11sop/cuppa/issues/134) / [#135](https://github.com/ja11sop/cuppa/issues/135) |
