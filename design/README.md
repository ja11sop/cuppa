...
| [`archive/cmake-package-prefix.md`](archive/cmake-package-prefix.md) | shipped | `env.PackageBin` / `CMakePrefixPathFor`; name↔slug; bare deps; default Ninja — ROADMAP 1.11.0 |
