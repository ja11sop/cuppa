...
| [`plans/toolchains-as-dependencies.md`](plans/toolchains-as-dependencies.md) | in progress | Fetched compilers as toolchain deps (Clang archives + cached discover; list/remove later) |
