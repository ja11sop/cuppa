...
| `GLOB_RECURSE` sources | `env.StaticGlob` or SCons `env.Glob('**/*.cpp', …)` | Static = configure snapshot; dynamic = build-graph aware — [`static-glob-rename.md`](static-glob-rename.md) |
