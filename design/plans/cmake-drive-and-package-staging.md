...
Antora section under [`dependencies/publishing/amend-and-external.adoc`](../../docs/modules/ROOT/pages/dependencies/publishing/amend-and-external.adoc) (“Publishing from an external CMake build”), cross-link from [`custom-commands.adoc`](../../docs/modules/ROOT/pages/methods/custom-commands.adoc).
